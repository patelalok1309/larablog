    ...
    <div class="d-flex justify-content-between flex-column">
        ...
        <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class='form-group'>
                ...
                <textarea name="content" id="content" cols="30" rows="7" class="form-control" placeholder="Enter post content..."></textarea>
            </div>

            <div class='form-group'>
                <label for='title' class='form-label'>Excerpt</label>
                <textarea name="excerpt" id="excerpt" cols="30" rows="5" class="form-control" placeholder="Enter excerpt for post..."></textarea>
            </div>
