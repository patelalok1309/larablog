      ...
      <div class="navbar yellow-green navbar-default yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav yellow-green navbar-nav">
            ...
            <li> <a href="about.html" class="dropdown-toggle active">About Me</a></li>
            ...
            <div class="col-md-12 nopadding">
              <div class="blog1-post-holder">
                ...
                <div class="text-box-inner">
                  <h4 class="dosis uppercase less-mar3"><a href="#">About me</a></h4>
              ...
              <br/>
                  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est. Curabitur eget orci. Cras laoreet ligula. Etiam sit amet dolor. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nullam tellus diam, volutpat</p>
                  <br/>
                  <h4 class="dosis uppercase less-mar3"><a href="#">Follow Me</a></h4>
                  <br/>
          ...
          <div class="col-md-4">
            <div class="col-md-12 nopadding">
              <div class="blog1-sidebar-box">
                ...
                <div class="text-box-inner">
                  <h5 class="uppercase dosis">Photographer & Blogger</h5>
              ...
              <div class="blog1-sidebar-box">
                <div class="text-box-inner">
                  ...
                  <ul class="sidebar-works">
                    ...
                    <li><a href="#"><img src="http://placehold.it/90x90" alt=""/></a></li>
                    <li><a href="#"><img src="http://placehold.it/90x90" alt=""/></a></li>
                    <li class="last"><a href="#"><img src="http://placehold.it/90x90" alt=""/></a></li>
                  </ul>
                </div>
              </div>
            </div>
