...
<head>
    ...
    <link rel="stylesheet" media="screen" href="{{ asset('front-assets/css/responsive-leyouts.css') }}"
        type="text/css" />
            ...
            <div class="container">
                <div class="topbar-left-items">
                    <ul class="toplist toppadding pull-left paddtop1">
                        <li class="rightl"><i class="fa fa-phone"></i> {{ getSiteOption('site_phone') }}</li>
                        <li><i class="fa fa-envelope"></i> {{ getSiteOption('site_email') }}</li>
                    </ul>
                </div>
                <!--end left-->
                ...
                <div class="topbar-right-items pull-right">
                    <ul class="toplist toppadding">
                        ...
                        <li><a href="{{ getSiteOption('site_social_links.instagram') }}"><i
                                    class="fa fa-instagram"></i></a></li>
                        <li class="last"><a href="{{ getSiteOption('site_social_links.linkedin') }}"><i
            ...
            <div class="container ">
                <div class="row">
                    <div class="col-md-2"> <br />
                        <img src="{{ asset('front-assets/images/flogo.png') }}" alt="" />
                    </div>
                    <div class="col-md-10">
                        <blockquote class="style1"><span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                                ...
                                Cras tellus. In pulvinar lectus a est. Curabitur eget orci.</span></blockquote>
                    </div>
                </div>
            </div>
        </section>
